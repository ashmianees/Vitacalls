...
if (isset($_POST['submit']))
{
	...
	$query="insert into activity(id,amount_of_cal,images)values('$lid','$gra','$filename')";
  ...
  <section class="home-section">
    ...
    <!-- <div class="content"> -->
      <div class="right-side">
        <div class="topic-text">DAILY FOOD INTAKES</div><br>
        <form id="form" method="post" enctype="multipart/form-data">
          <div>
            
			<div class="input-box">
              <input type="text" placeholder="Enter Product Name" name="calorie" id="p1" required />
              <p id="error1"><b style='font-family:cursive; font-size:12px; color:red;'> &nbsp;&nbsp;Enter Valid Name </p><br><br><br>
            </div>    
            <div class="input-box">
            <input type="file" accept="image/png, image/gif, image/jpeg" placeholder="Upload image" name="images" required>
            </div>
