...
if (isset($_POST['sub']))
{
    ...
    $txt5=$_POST['info'];
	$query="insert into query(id,age,weight,height,bp,sugar,cholesterol,info)values('$lid','$txt','$txt1','$txt2','$txt3','$txt4','$txt5')";
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
  <script>
	...
	var diseases=/^(?![0-9]+$)[a-zA-Z0-9\s\,\#\-]+$/;
      ...
      $(".btn").click(function() {
        if (v1 == 0  && v2 == 0 && v3 == 0 && v4 == 0 && v75== 0 && v76== 0)
          return true;
        else {
  ...
  <section class="home-section">
	...
	<h1>DETAILS</h1>
        ...
        <div class="info">
          ...
          <div  class="info-item">
            <label >Email</label>
            <input type="text" name="email" id="email" value="<?php echo $row1['username']; ?>"  required/>
          </div>
           <div class="info-item">
              <input type="text" placeholder="Enter age" name="name" id="p1" required />
         ...
         <div class="info-item">
          ...
          <div class="info-item">
              ...
              <p id="error3"><b style='font-family:cursive; font-size:12px; color:red;'> &nbsp;&nbsp;Enter Valid Name </p><br>
            </div>
         <div class="info-item">
              <input type="text" placeholder="ENTER BLOOD PRESSURE" name="bp" id="p4" required />
              <p id="error4"><b style='font-family:cursive; font-size:12px; color:red;'> &nbsp;&nbsp;Enter Valid Name </p><br>
            </div>
          <div class="info-item">
              <input type="text" placeholder="CHOLESTEROL" name="cholesterol" id="p5" required />
              <p id="error5"><b style='font-family:cursive; font-size:12px; color:red;'> &nbsp;&nbsp;Enter Valid Name </p><br>
            </div>
		<div class="info-item">
              <input type="text" placeholder="ANY DISEASES" name="diseases" id="p6" required />
              <p id="error6"><b style='font-family:cursive; font-size:12px; color:red;'> &nbsp;&nbsp;Enter Valid Name </p><br>
            </div>
          <button type="submit"  name="sub"><a href="demo_profile.php">Submit</a></button>
          </form>
  </body>
  <script>
