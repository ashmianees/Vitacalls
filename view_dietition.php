...
<body>
    ...
    <div class="container">
      <table>
        <thead>
          <tr>
            <th colspan="4"><b>Employees Details </b>
            </b></i> <a href="dietition_reg.php"><button class="add-btn"> &nbsp;<i class='bx bx-arrow-back'> Add Dietitions
                </i></button></a></th>
          </tr>
        </thead>
        <tbody>
          ...
          <?php 
            ...
            $con=mysqli_connect("localhost","root","","miniproject");
              $query="select * from dietition_reg where status=1";
              $re=mysqli_query($con,$query);
      while ($row=mysqli_fetch_array($re))
      {
        $did=$row['did'];
            $query1 = "select * from dietition_log where status=2;";
        ...
        ?>
          <tr>
            ...
            <td><a href='dietition_details.php?id=<?php echo $row['did']; ?>'> <button
