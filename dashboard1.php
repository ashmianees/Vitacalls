...
<div id="mySidenav" class="sidebar">
  ...
  <button class="btn" ><a href="main.php">dashboard</a></button><br>
  <button class="btn" ><a href="client.php">Userstatus</a></button><br>
  <button class="btn" ><a href="view_dietition.php">Manage Employees</a></button><br>
  <button class="btn" ><a href="alocation.php">Alocate Dietitian</a></button><br>
  <button class="btn" ><a href="receipes.php">Recipes</a></button><br>
  <button class="btn" ><a href="amount.php">Payment</a></button><br>
  <button class="btn" ><a href="payment_view.php">User Payment </a></button><br>
  ...
  <button class="btn" ><a href="admin_logout.php">logout</a></button>
</div>
